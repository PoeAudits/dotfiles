...
-- Only loads on desktop systems where Omarchy manages the theme symlink
-- On servers, this plugin is disabled and a default theme is used

-- Check if we're on an Omarchy desktop (theme symlink exists)
...
if not is_omarchy_desktop then
  return {}
end
